...
# === 각 항목 처리 ===
converted_data['X'] = convert_to_ee(data['X'], data['X'][:, 5:7])
converted_data['Y'] = convert_to_ee(data['Y'], np.zeros((data['Y'].shape[0], 2)))[:, 1:5]
...
# 저장
np.savez("converted_all_data.npz", **converted_data)
